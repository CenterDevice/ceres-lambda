...
[![Build Status](https://dev.azure.com/centerdevice/ceres-lambda/_apis/build/status/CenterDevice.ceres-lambda?branchName=master)](https://dev.azure.com/centerdevice/ceres-lambda/_build/latest?definitionId=17&branchName=master)
