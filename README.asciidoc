...
* `security-watchtower` -- Checks credentials at DUO and AWS for last time used. If credentials with a longer period if inactivity are identified, those credentials will be destroyed.
